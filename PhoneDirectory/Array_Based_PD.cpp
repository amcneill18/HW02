...
/** Remove an entry
	...
	*/
string Phone_Directory::remove_entry(const string& delete_name) // Exercise 1.7: please complete the remove_entry() method - Ed/Kent
{

	//Justice & Andrew
	
	int index = find(delete_name);
	string old_number = the_directory[index].get_number();
	if (index != -1) {
